...
* An illustrated and opinionated HowTo on setting up RedHat OpenShift Data Science environments (RHODS)
...
* There is no warranty of any kind, expressed or implied, regarding the accuracy, adequacy, validity, reliability, or completeness of this content.
...
* Should you find inaccuracies in this content, please open an Issue in the link:https://github.com/erwangranger/FastTrack-to-RHODS[github project] in order to bring it to my attention.

=== Freshness

It is possible that this document falls behind as things evolve.

If unsure, check the history of the page in the link:https://github.com/erwangranger/FastTrack-to-RHODS[github project] to see when it was last updated.
